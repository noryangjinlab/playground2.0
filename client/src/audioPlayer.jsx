...
const Audioplayer = styled.div`
  ...
  @media (max-width: 1000px) {
    ...
    .channel-details[open] > .channel-summary::before {
      content: "▾";
    }
...
function AudioPlayer({ onSend, props }) {
  ...
  useEffect(() => {
    ...
    if (analyzerRef.current) return; // 중복 생성 방지
  ...
  return (
    ...
    >
      ...
      <div className='audio-box'>
        <div className='audio-content'>
          ...
          >
            <div ref={marqueeBoxRef} style={{
              textAlign: 'left',
              margin: isMobile ? '0 10px 5px 10px' : '0 16px 8px 16px',
              overflow: 'hidden',
              whiteSpace: 'nowrap',
            ...
            <div style={{
              ...
              textAlign: 'left',
              margin: isMobile ? '0 10px 7px 10px' : '0 16px 10px 16px',
            }}>
            ...
            <div style={{
              ...
              padding: isMobile ? '0 10px 0 10px' : 0
            }}>
              <span style={{marginRight: isMobile ? '0px' : '7px'}} className="current-time">{formatTime(currentTime)}</span>
              <div style={{
                width: '300px',
                height: '20px',
                display: 'flex',
                ...
                <input
                  ...
                  ref={sliderRef}
                  onChange={handleSeek}
                  style={isMobile ? { width: '100%', margin: '0 7px' } : undefined}
                />
              </div>
              <span style={{marginLeft: isMobile ? '0px' : '7px'}} className="total-duration">{formatTime(duration)}</span>
            </div>
          ...
          </div>
          {
            ...
            <div style={{
              ...
              <details className="channel-details" ref={detailsRef} style={{
                ...
                <summary className='channel-summary'><div style={{
                  minWidth: 0,
                  overflow: 'hidden',
                  whiteSpace: 'nowrap',
                  ...
                  channel{channel+1} _ {audioData[audioData.length - 1][channel]}
                </div></summary>
                <ul style={{
                  listStyle: 'none',
                  margin: 0,
                ...
                }}>
                {
                  audioData[audioData.length - 1].map((e, i)=> {
                    return (
                      <li>
                        <div className={(i == channel) ? 'mobile-menu-selected' : ""} style={{
                          lineHeight: '25px'
                        }} onClick={()=>{
                          setChannel(i)
                          setIndex(0)
        ...
        {!isMobile && <div className='audio-menu'>
          {
            audioData[audioData.length - 1].map((e, i)=>{
              return (
                <div key={i} style={{
